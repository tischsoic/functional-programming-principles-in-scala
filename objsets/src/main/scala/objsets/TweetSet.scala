...
//    ((left union that) union right) incl elem
  ...
  override def mostRetweeted: Tweet = {
    ...
    if (!left.isEmpty && mostRetweetedLeft.retweets > elem.retweets)
      if (!right.isEmpty && mostRetweetedRight.retweets > mostRetweetedLeft.retweets)
        mostRetweetedRight else mostRetweetedLeft
    else
      if (!right.isEmpty && mostRetweetedRight.retweets > elem.retweets)
        mostRetweetedRight else elem
  }
